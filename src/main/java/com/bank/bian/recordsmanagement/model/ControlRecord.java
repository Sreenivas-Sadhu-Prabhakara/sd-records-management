package com.bank.bian.recordsmanagement.model;
...
/**
 * The BIAN control record for this service domain: "Record Archive Maintenance Agreement".
 *
 ...
 * to its asset type (Record Archive). Phase 1 keeps a generic, shallow shape;
...
public class ControlRecord {
    ...
    private final String controlRecordType = "Record Archive Maintenance Agreement";
